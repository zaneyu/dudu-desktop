...
public sealed class PreferencesRepository(Database database) : SqliteRepository(database), IPreferencesRepository
{
    public async Task<Preferences?> GetAsync(CancellationToken cancellationToken)
    {
        ...
        return new((AppTheme)reader.GetInt32(0),new QuietHours(reader.GetInt32(1)!=0,ReadTime(reader[2]),ReadTime(reader[3])),reader.GetInt32(4)!=0,reader.GetInt32(5),reader.GetInt32(6)!=0,reader.GetInt32(7)!=0,reader.GetInt32(8)!=0,TimeSpan.FromTicks(reader.GetInt64(9)));
    }
